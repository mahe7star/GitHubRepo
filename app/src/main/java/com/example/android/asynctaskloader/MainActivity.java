...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (1) Create a static final key to store the query's URL
     private static final String SEARCH_QUERY_URL="results";
    // TODO (2) Create a static final key to store the search's raw JSON
     private static final String JSON_RAW_DATA="jsonData";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            ...
            String jsonQuery=savedInstanceState.getString(JSON_RAW_DATA);

            mSearchBoxEditText.setText(searchqueryurl);
            mUrlDisplayTextView.setText(jsonQuery);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(JSON_RAW_DATA,jsonData);
    }
